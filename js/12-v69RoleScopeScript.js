...
(function(){
 ...
 /* ---------- 2. role presets ---------- */
 /* The technician set agreed with the user: Field Service, Calendar, QC, Machines (read),
    Documents, Notifications — plus the role Home itself. Deliberately no Dashboard, no
    Cases list, no Customers, no Warranty, no company Reports, no Spare Parts, no Petty
    Cash, no Onsite pricing. */
 ...
 var SCOPE_VERSION=2;   /* bump to re-run the migration when these sets change */
 function migrate(){
