/* jsQR 1.4.0 — QR decoder (Apache-2.0), https://github.com/cozmo/jsQR
   Vendored on 2026-09-08 from https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.min.js
   Kept in the repo instead of loaded from a CDN so a customer can still scan a machine
   QR when the site is opened from file://, from GitHub Pages behind a network that
   blocks CDNs, or with no connection at all. Loaded lazily by js/14 only when the
   visitor taps the scan button, so it costs nothing at boot. Source map link removed. */
/**
